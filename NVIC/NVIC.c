...
void NVIC_init(void)
{
			...
			NVIC_APINT |= ( 0xffff0000 | (0x05FA<<16));    /*this  field must be written to this value in order to change the bits in this register*/
			NVIC_APINT |= ( 0x00000700 | (0x6<<8));  /*set the priority compination to be xyy (goup subgroup subgroup)*/
